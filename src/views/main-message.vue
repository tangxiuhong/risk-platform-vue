<template>
  <div class="mesStyle" v-show="mesHide" ref="myMessage" :class="mesStyle?'mesinto1':'mesinto2'">
    <div class="mesinto">
      <el-row>
        <el-col>
          <el-row>
            <el-col :span="22"><p class="mesTitle">{{ title }}</p></el-col>
            <el-col :span="2"><i class="el-icon-close" style="font-size: 18px;" @click="mesHidden"></i></el-col>
          </el-row>
        </el-col>
        <el-col>
          <div>
