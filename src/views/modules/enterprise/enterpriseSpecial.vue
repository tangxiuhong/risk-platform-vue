  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('enterprise/enterpriseSpecial/save')" type="primary" @click="addOrUpdateHandle()">新增
        </el-button>
        <el-button v-if="isAuth('enterprise/enterpriseSpecial/delete')" type="danger" @click="deleteHandle()"
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button v-if="isAuth('enterprise/enterpriseSpecial/update')" type="text" size="small"
          ...
          <el-button v-if="isAuth('enterprise/enterpriseSpecial/delete')" type="text" size="small"
...
<script>
  import AddOrUpdate from './enterpriseSpecial-add-or-update'
  import Look from './enterpriseSpecial-look'
    ...
    methods: {
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定要删除吗?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/enterprise/enterpriseSpecial/delete'),
            method: 'post',
