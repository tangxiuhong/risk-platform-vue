<template>
  <div class="sensorBox" style="overflow:scroll">
    <div class="sensorClose"><i class="el-icon-close" @click="sensorWarnOff"></i></div>
    <div class="sensorTitle">传感器预警详细信息：</div>
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          ...
          if (data && data.code === 0) {
            console.log(this.dataForm.sensor)
