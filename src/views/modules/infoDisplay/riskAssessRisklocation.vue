<template>
  ...
  <div class="mod-config">
    ...
    <el-carousel trigger="click">
      <el-carousel-item v-for="item in pictures" :key="item.pictureUrl">
        <div id="picBox" ref="picSvgDiv" style="width: 700px; height: 500px;">
          <svg v-html="pictures.pictureUrl" style="width: 500px; height: 500px" ref="picSvg" version="1.1"
          xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink"></svg>
        </div>
      </el-carousel-item>
...
<style>
  ...
  .mod-config .el-carousel__container{
    height: 660px;
  }
