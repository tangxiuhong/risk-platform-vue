...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      init (checkDowfList, checkId, checkDowfId) {
        this.resetForm('dataForm')
        this.dataForm.id = checkDowfId
        this.dataForm.oldId = checkDowfList.id
        ...
        this.dataForm.checkDowfId = checkDowfId
        this.visible = true
        this.$nextTick(() => {
