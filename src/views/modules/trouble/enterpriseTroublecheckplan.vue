  ...
  <div>
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('trouble/enterpriseTroublecheckplan/save')" type="primary" @click="addOrUpdateHandle()">
          新增
        </el-button>
        <el-button v-if="isAuth('trouble/enterpriseTroublecheckplan/delete')" type="danger" @click="deleteHandle()"
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="scope.row.paramter1 === '1'" type="text" size="small"
          ...
          <el-button v-if="isAuth('trouble/enterpriseTroublecheckplan/delete')" type="text" size="small"
...
<script>
  import AddOrUpdate from './enterpriseTroublecheckplan-add-or-update'
