          ...
          <el-row>
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
              <el-form-item label="安全检查任务编号" prop="planNo">
                <el-select v-model="dataForm.planNo" placeholder="安全检查任务编号" @change="planNoChange"
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="隐患编号" prop="troubleNum">
                <el-input v-model="dataForm.troubleNum" placeholder="隐患编号" readonly="true"></el-input>
              </el-form-item>
            </el-col>
            <!-- 第三行 -->
            ...
            <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
              <el-form-item label="责任人" prop="person">
                <el-select v-model="dataForm.person" :disabled="this.dataForm.status==1" :filterable="true">
                  <el-option
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="" prop="checkTime">
                ...
                <span>定期(日常)</span>
                <span style="color:blue;">{{dataForm.checkType==1 ? '安全综合检查': dataForm.checkType==2 ? '专业安全检查': dataForm.checkType==3 ? '专项安全检查': dataForm.checkType==4 ? '日常检查': dataForm.checkType==5 ? '自主管理': dataForm.checkType==6 ? '风险日常管理': '' }}</span>
...
<script>
  ...
  export default {
    ...
    methods: {
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.planNo = data.enterpriseTroublerecord.planNo
                ...
                this.getRiskUnit()
                this.dataForm.riskUnit = data.enterpriseTroublerecord.unitId
                this.getRiskPoint()
                this.dataForm.riskPoint = data.enterpriseTroublerecord.riskId
              }
            })
          } else {
      ...
      planNoChange () {
        this.$http({
          url: this.$http.adornUrl(`/trouble/enterpriseTroublerecord/getCheckTypeByPlanNo/` + this.dataForm.planNo),
          method: 'get',
          params: this.$http.adornParams()
        }).then(({data}) => {
          if (data && data.code === 0) {
            this.dataForm.checkType = data.checkType
          }
        })
      },
      initDepartmentList () {
