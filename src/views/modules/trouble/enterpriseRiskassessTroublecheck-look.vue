...
<script>
  ...
  export default {
    ...
    methods: {
      init (troubleNum) {
        this.dataForm.troubleNum = troubleNum || 0
        this.visible = true
        this.$nextTick(() => {
          this.$refs['dataForm'].resetFields()
          if (this.dataForm.troubleNum) {
            this.$http({
              url: this.$http.adornUrl(`/trouble/enterpriseTroublerecord/lookInfoByTroubleNum/${troubleNum}`),
              method: 'get',
