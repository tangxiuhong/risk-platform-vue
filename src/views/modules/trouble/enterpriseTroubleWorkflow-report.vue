<template>
  <el-dialog
    :title="!dataForm.id ? '隐患上报' : '上报信息修改'"
    :close-on-click-modal="false"
    :visible.sync="visible" append-to-body width="60%">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
             label-width="150px">

      <el-form-item label="上报情况说明" prop="reportDescription">
        <el-input type="textarea" v-model="dataForm.reportDescription"></el-input>
      </el-form-item>
      <el-form-item label="上报单位" prop="actionDepartment">
        <el-select v-model="dataForm.actionDepartmentName" clearable filterable placeholder="请选择上报单位" @change=departmentChange>
          <el-option
