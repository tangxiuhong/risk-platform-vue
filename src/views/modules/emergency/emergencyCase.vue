  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('emergency/emergencyCase/save')" type="primary" @click="addOrUpdateHandle()">新增
        </el-button>
        <el-button v-if="isAuth('emergency/emergencyCase/delete')" type="danger" @click="deleteHandle()"
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('emergency/emergencyCase/update')" type="text" size="small"
          ...
          <el-button v-if="isAuth('emergency/emergencyCase/delete')" type="text" size="small"
...
<script>
  import AddOrUpdate from './emergencyCase-add-or-update'
  import Look from './emergencyCase-look'
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/emergency/emergencyCase/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定要删除吗?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/emergency/emergencyCase/delete'),
            method: 'post',
